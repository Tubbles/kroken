...
2. **Editor integration**: a micro Lua plugin that spawns kroken as a background job and pastes the result. Lives outside this repository; this repository documents the protocol in `doc/editor-integration.md`.
